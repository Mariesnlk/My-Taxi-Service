...
public class OrderDAOImpl implements OrderDAO {
    ...
    public void create(Order order) {
        ...
        try {
            ...
            Integer passengerId = order.getPassengersId();
            ...
            String query = "INSERT INTO taxi_service_db.order(addressFrom, addressTo, passengersNumber, " +
    ...
    public Order findById(Integer idOrder) {
        ...
        try {
            ...
            String query = "SELECT * FROM taxi_service_db.order WHERE id= ?";
            ps = connection.prepareStatement(query);
    ...
    public List<Order> findAll() {
        ...
        try {
            ...
            String query = "SELECT * FROM taxi_service_db.order";
            ps = connection.prepareStatement(query);
    ...
    public boolean delete(Order order) {
        ...
        try {
            ...
            String query = "DELETE FROM taxi_service_db.order WHERE id = ?";
            ps = connection.prepareStatement(query);
    ...
    public List<Order> sortDateIncrease() {
        ...
        try {
            ...
            String query = "SELECT * FROM taxi_service_db.order ORDER BY date ASC";
            ps = connection.prepareStatement(query);
    ...
    public List<Order> sortDateDecrease() {
        ...
        try {
            ...
            String query = "SELECT * FROM taxi_service_db.order ORDER BY date DESC";
            ps = connection.prepareStatement(query);
    ...
    public List<Order> sortPriceIncrease() {
        ...
        try {
            ...
            String query = "SELECT * FROM taxi_service_db.order ORDER BY price ASC";
            ps = connection.prepareStatement(query);
    ...
    public List<Order> sortPriceDecrease() {
        ...
        try {
            ...
            String query = "SELECT * FROM taxi_service_db.order ORDER BY price DESC";
            ps = connection.prepareStatement(query);
