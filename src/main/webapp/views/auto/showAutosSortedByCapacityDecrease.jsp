...
<div>
    <h1>Sorted Autos By Capacity Decrease</h1>
</div>
...
<div>
    <div>
        ...
        <%
            List<Auto> autos = (List<Auto>) request.getAttribute("allSortedByCapacityDecreaseAutos");
...
<div>
    ...
    <input class="button" type=button onClick="location.href='/add-auto'" value='Add User'>
</div>
